		...
		function S(aG) {
			...
			if (aM.mode == "time") {
				...
				aB = function(aX) {
					...
					var aW = a0 * aJ[a3];
					if (a3 == "second") {
						a1.setSeconds(a(a1.getSeconds(), a0))
					}
					if (a3 == "minute") {
						a1.setMinutes(a(a1.getMinutes(), a0))
					}
					if (a3 == "hour") {
						a1.setHours(a(a1.getHours(), a0))
					}
					if (a3 == "month") {
						a1.setMonth(a(a1.getMonth(), a0))
					}
					if (a3 == "year") {
						a1.setFullYear(a(a1.getFullYear(), a0))
					}
					...
					do {
						...
						if (a3 == "month") {
							if (a0 < 1) {
								...
								a1.setMonth(a1.getMonth() + a0)
							}
						} else {
							if (a3 == "year") {
								a1.setFullYear(a1.getFullYear() + a0)
							} else {
								a1.setTime(a4 + aW)
							}
						}

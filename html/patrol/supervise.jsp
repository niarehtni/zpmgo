		...
		$(document).ready(function() {
			var p={
	            ...
	            detail:{
             	...
             	,edit:{
					url:"<%=basePath%>patrol/patrolEvent_get.action?pageBean.listUser=<%=session.getAttribute("username")%>&type=supervise",
					name:"批示",
					width:1000,
					height:600,
					primaryKey:"patrolEventBean.peid"
             	...
             	,exportExcel:{
		        	url:"<%=basePath%>patrol/patrolEventExport_exportSuperviseExcel.action",
		        	title:"事件督办"
			    }
			};

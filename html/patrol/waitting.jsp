...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form action="<%=basePath%>patrol/patrolEvent_listWaitting.action">
				...
				<tbody>
					<tr>
						<td>
							...
							事件内容<input type="text" name="patrolEventBean.content"/>
			...
			var p={
	            ...
	            colModel: [
					{display: '操作', name: 'TYPE', width: 35, sortable: true,
						...
						var detailBtn = "<img title='详情' onclick='top.addTab({href:\""+href+"\",name:\"事件详情\"});' src='<%=basePath%>/images/jquery/flexgrid/detail.png' style='cursor:pointer' />";

						href="<%=basePath%>patrol/patrolEvent_get.action?pageBean.listUser=<%=session.getAttribute("username")%>&type=edit";
						href+="&patrolEventBean.peid="+row.PRIMARYKEY;
						var handleBtn = "<img title='办理' onclick='top.addTab({href:\""+href+"\",name:\"事件办理\"});' src='<%=basePath%>/images/jquery/flexgrid/edit.gif' style='cursor:pointer' />";
						return detailBtn+" "+handleBtn;
						}
					},
	            	...
	            	{display: '下发科室', name: 'HANDLEDEPTNAME', width: 55, sortable: true},
             	...
             	add:{
					url:"<%=basePath%>patrol/patrolEvent_addInit.action",
					name:"上报事件",
					width:1000,
					height:600
   		        }
	            ,detail:{
             	...
             	,edit:{
					url:"<%=basePath%>patrol/patrolEvent_get.action?pageBean.listUser=<%=session.getAttribute("username")%>&type=edit",
					name:"办理",
					width:1000,
					height:600,
					primaryKey:"patrolEventBean.peid"
             	...
             	,exportExcel:{
		        	url:"<%=basePath%>patrol/patrolEventExport_exportWaittingExcel.action",
		        	title:"待办事件"
			    }
			};
